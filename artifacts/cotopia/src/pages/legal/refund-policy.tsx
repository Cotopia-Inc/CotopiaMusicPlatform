  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
      ...
      <Section title="1. Submission Fees">
        ...
        <p>In the event of a technical payment error that results in a double charge, please contact us within 7 days at <a href="mailto:legal@cotopia.com" className="text-primary hover:underline">legal@cotopia.com</a> and we will investigate and issue a correction where verified.</p>
      </Section>
      ...
      <Section title="2. Promotion Fees">
        ...
        <p>If your campaign has not yet started, please contact us at <a href="mailto:legal@cotopia.com" className="text-primary hover:underline">legal@cotopia.com</a> within 24 hours of payment to request a cancellation review.</p>
      </Section>
      ...
      <Section title="4. Fraudulent Chargebacks">
        ...
        <p>If you believe a charge was made in error, contact us at <a href="mailto:legal@cotopia.com" className="text-primary hover:underline">legal@cotopia.com</a> before filing a dispute with your payment provider.</p>
      </Section>

      <Section title="5. Contact for Billing Issues">
        <p>For all billing inquiries, potential errors, or refund requests, contact us at <a href="mailto:legal@cotopia.com" className="text-primary hover:underline">legal@cotopia.com</a> with your account email, transaction reference, and a description of the issue.</p>
        <p>We aim to respond to billing inquiries within 3 business days.</p>
      </Section>

      <div className="pt-4 border-t border-border">
        <p className="text-xs text-muted-foreground">Billing questions: <a href="mailto:legal@cotopia.com" className="text-primary hover:underline">legal@cotopia.com</a></p>
      </div>
    </div>
  );
}
