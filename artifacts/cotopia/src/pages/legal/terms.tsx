  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
      ...
      <div className="pt-4 border-t border-border">
        <p className="text-xs text-muted-foreground">Questions? Contact <a href="mailto:legal@cotopia.com" className="text-primary hover:underline">legal@cotopia.com</a></p>
      </div>
    </div>
  );
}
