...
export const appSettingsTable = pgTable("app_settings", {
  ...
  dmcaContactEmail: text("dmca_contact_email").default("legal@cotopia.com"),
  copyrightAgentInfo: text("copyright_agent_info").default("Cotopia Legal Team, legal@cotopia.com"),
